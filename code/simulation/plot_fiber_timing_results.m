...
% figure; hold on;
% for i = 1:3
%     yline(i,'color',green4(85*(i-1)+5,:),'linewidth',3); 
% end
% hold off; box on
% xlim([0,1.5]); ylim([0,3.5]);
...
for i = 1:4
    ...
    plot(t,fiber,'color',blue1(50*i,:),'linewidth',3);
    xline(T_fiber(i),'--','color',blue1(50*i,:),'linewidth',1.2);
...
for j = [20,21,22,24]
    ...
    line(t, curv, 'color', green4(85*(i-1)+5,:), 'linewidth', 3, 'DisplayName', [' \itd\rm = ' num2str(i)]); 
